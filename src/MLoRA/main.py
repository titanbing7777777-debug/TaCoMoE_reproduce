...
def main(parser):
   ...
   # model_args.peft_path = '/home/gaofei/MOELoRA/saved/chatglm3/zh/total_w_oos/checkpoint-43720'
    if model_args.peft_path is not None:
        logger.info("Peft from pre-trained model")
        # Resume_training
       # training_args.resume_from_checkpoint = '/home/gaofei/MOELoRA/saved/chatglm3/zh/total_w_oos/checkpoint-43720'
    ...
    if training_args.do_train:
        checkpoint = None
        #training_args.resume_from_checkpoint = '/home/gaofei/MOELoRA/saved/en/total_fine_cot/checkpoint-28956'
        if training_args.resume_from_checkpoint is not None:
